...
=========================================================================== -->
	<!--タイトル（モバイル）-->
	<!--背景-->
	<div class="title_box3 mobile_only">
		<!--コピー-->
		<p class="about_title_0">ご予約・お問合せ</p>
		<!-- /title_box -->
	</div>

	<!--タイトル（PC）-->
	<!--背景-->
	<div class="title_box3 pc_only">
		<!--パンくずリスト-->
		<div class="topicPath">
...
=========================================================================== -->
	...
	<div class="order_1">
		<!--タイトル-->
		<h2><span class="flow_a_title"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/16_order_title01.png" class="center-block" alt="直接お電話で"></span>
		</h2>
...
=========================================================================== -->
	...
	<div class="order_2">
		<!--タイトル-->
		<h2><span class="flow_a_title"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/16_order_title02.png" class="center-block" alt="メールフォームから"></span>
		</h2>
